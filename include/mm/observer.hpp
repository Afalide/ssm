...
#ifndef MANIACMACHINES_OBSERVER_HPP
#define MANIACMACHINES_OBSERVER_HPP
...
void declare_handle_impl (t_context* context, i_event_list_container* container)
{
    ...
    if (! evt_list-> has_caller ())
    {
        ...
        std::cout << __FUNCTION__ << " setting caller" << std::endl;
    ...
    std::cout << __FUNCTION__ << " a class is already registered as a caller for this event type" << std::endl;
}
...
#endif //MANIACMACHINES_OBSERVER_HPP
